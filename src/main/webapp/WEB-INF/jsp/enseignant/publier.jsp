        ...
        <div class="col-md-10 col-lg-8">
            <div class="card card-premium">
                <div class="card-header-clean">
                    <h3 class="fw-bold mb-1 text-dark" style="letter-spacing: -0.02em;">Nouveau Cours</h3>
                    <p class="text-muted mb-0 small">Remplissez les informations pour publier votre formation.</p>
                </div>
                    ...
                    <form id="coursForm" novalidate>
                        <div class="mb-4">
                            ...
                            <input type="text" id="titre" name="titre" class="form-control"
                                   placeholder="Ex: Maîtrisez Java Spring Boot" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="contenu" name="contenu" class="form-control"
                                      rows="10" placeholder="Développez votre leçon ici..." required></textarea>
